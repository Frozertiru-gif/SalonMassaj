...
class BackupServiceRestoreCompatTests(unittest.TestCase):
    ...
    def test_filter_incompatible_sql_settings_removes_unsupported_timeout_set_only(self):
        service = self._make_service()
        ...
        self.assertEqual(target_path.read_text(encoding="utf-8"), "SET statement_timeout = 0;\nSELECT 1;\n")

    def test_restore_execution_non_zero_always_raises(self):
        service = self._make_service()
