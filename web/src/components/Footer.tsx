  ...
  return (
    <footer className="border-t border-blush-100 bg-white/70 py-12">
      <Container className="grid gap-8 text-sm text-ink-700 md:grid-cols-3">
        <div>
          <p className="text-base font-semibold text-ink-900">Salon Massaj</p>
          <p className="mt-3">Нежный уход, глубокое расслабление и атмосфера спокойствия.</p>
        </div>
        <div>
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li>Email: hello@salonmassaj.ru</li>
          </ul>
        </div>
        <div>
          <p className="text-base font-semibold text-ink-900">Мы в соцсетях</p>
          <ul className="mt-3 space-y-2">
            <li>Instagram: @salonmassaj</li>
            <li>Telegram: @salonmassaj</li>
